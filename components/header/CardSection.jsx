  ...
  return (
    <div className="flex text-white">
      <div className="relative w-[140px] sm:w-[180px] 2xl:w-[212px] flex flex-col items-center bg-cover bg-center tracking-widest">
        ...
        <div className="bg-black bg-opacity-40 hover:bg-white hover:text-black h-[34px] sm:h-[38px] 2xl:h-[45px] mt-[10px] flex justify-center rounded-lg border border-white text-center w-full">
