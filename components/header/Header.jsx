...
export default function Header() {
  ...
  return (
    <>
      <header className="flex justify-between items-center text-white px-4 lg:px-10 3xl:px-16 pt-9 3xl:pt-14">
        <div className="flex items-center w-full">
          ...
          <div className="flex items-center gap-3 md:gap-6 flex-1"> 
            <img
              ...
              className="cursor-pointer max-md:h-4 max-3xl:h-9"
            />
            <img src="/assets/Group 3385.png" alt="Zima Logo" className="max-md:h-4 max-3xl:h-9" />
          </div>

          {/* Second Div */}
          <div className="flex justify-center flex-1">
            <img src="/assets/Group 3005.png" alt="Center Logo"  className="max-md:h-4 max-3xl:h-9" />
          </div>
